...
- Factorial is a method that returns the factorial of that number.
- Reverse is a method which return the a string written in reversed.
- Fizzbuzz is a method which returns "fizz" numbers divisible by 3, "buzz" numbers divisible by 5 and "fizzbuzz" by both.
...
- [ ] Add more methods to test TDD development.
